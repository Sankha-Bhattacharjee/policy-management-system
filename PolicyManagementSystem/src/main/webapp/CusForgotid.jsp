...
function validate(){
	...
	var phn=document.getElementById("contactNumber").value;
	if(qsn1==""){
...
<form:form onsubmit="return validate()" action="cforgotuid1" method="post" modelAttribute="name" style="margin-top:50px;margin-left:30px;">
